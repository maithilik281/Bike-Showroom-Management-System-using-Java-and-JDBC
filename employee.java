...
public class employee extends Frame implements ActionListener,ItemListener
{
    ...
    setForeground(Color.black);
		...
		l2=new Label("Enter Employee Number");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
			...
			if(str.equals("Save"))
			{
	            ...
	            eename=t2.getText();
	            eeadd=t3.getText();
	            eemob=Integer.parseInt(t4.getText());
			...
			//String strr=" ";
	            ...
	            eemob=Integer.parseInt(t4.getText());
	            //eesal=Integer.parseInt(t5.getText());
				String str2="Update employee set emob="+eemob+", where ename="+eename;
